            ...
            <div className="container" style={{
                ...
                <div>
                    ...
                    <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        {['home', 'about', 'members', 'genealogy', 'services', 'projects', 'gallery', 'contact'].map(page => (
                            <li key={page}>
                                <button
                                ...
                                >
                                    {page === 'home' ? 'Home' : page === 'about' ? 'About Us' : page === 'members' ? 'Club Members & Leaders' : page === 'genealogy' ? 'District Genealogy' : page === 'services' ? 'Areas of Focus' : page === 'projects' ? 'Our Projects' : page === 'gallery' ? 'Gallery' : 'Contact Us'}
                                </button>
                            </li>
                        ))}
                    </ul>
